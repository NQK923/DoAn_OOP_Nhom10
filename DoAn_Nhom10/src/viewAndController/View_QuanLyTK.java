 ...
 * @author HP
 */
public class View_QuanLyTK extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Chọn Tài Khoản Muốn Xóa");

        jLabel3.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/icons8-delete-key-64.png"))); // NOI18N
    ...
    private void jLabel3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel3MouseClicked
        ...
        if (selectedIndex >= 0) {
            Account account = listAcc.get(selectedIndex);
            int option = JOptionPane.showConfirmDialog(this, "Bạn có muốn xóa dòng đã chọn!");
            if (option == 0) {
                ConnectToXampp.deleteAccount(account.getUserName());
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(View_QuanLyTK.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new View_QuanLyTK().setVisible(true);
            }
        });
    }
    ...
    private void createTable(List<Account> listAcc) {

        DefaultTableModel table = new DefaultTableModel();
        acc_Table.setModel(table);
        table.addColumn("Tên tài khoản");
        table.addColumn("Gmail");
        table.addColumn("Mật khẩu");

        for (Account account : listAcc) {
            table.addRow(new Object[]{account.getUserName(), account.getGmail(), account.getPassWord()});
        }

    }

    private void deleteRowTable() {
        DefaultTableModel tb = (DefaultTableModel) acc_Table.getModel();
        int count = acc_Table.getRowCount();
